...
// нормализуем lat/lon-диапазон сэмплов в 0..1, рисуем оваль и текущую позицию.
// Это и есть прототипная геометрия трека из generator.ts (овал вокруг
// центроида трассы), а не точная топология автодрома.
const VB = 100
const PAD = 6
