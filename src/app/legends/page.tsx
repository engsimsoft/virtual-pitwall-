    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/legends/demo" className="bg-white text-red-600 px-8 py-3 rounded-lg font-medium hover:bg-red-50">
              Посмотреть демо
            </a>
            <a href="/legends/artline" className="border border-white px-8 py-3 rounded-lg font-medium hover:bg-red-500">
              ArtLine Demo
            </a>
          </div>
        </div>
