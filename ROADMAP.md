...
UI-прототип облачной части TMS Telos с фирменным flagship-экраном античита и role-switcher TMS/клиент/гонщик; M0-M2 закрыты (инфраструктура, mock data, оба anti-cheat showcase-экрана), дорога открыта в M3 (парк, паспорт мотора, инциденты, чёрный ящик). Тёмная палитра отложена до фиксации брендинга TMS.
