...
UI-прототип облачной части TMS Telos с фирменным flagship-экраном античита и role-switcher TMS/клиент/гонщик; M0-M3 закрыты (инфраструктура, mock data, anti-cheat showcase, парк/паспорт/инциденты/чёрный ящик), брендинг разморожен. Дорога открыта в M4 (role switcher над всеми экранами + landing). Тёмная палитра остаётся отложенной как отдельный visual overhaul.
