...
- [ ] Спроектировать `src/lib/mockData/` структуру и типы
...
UI-прототип облачной части TMS Telos с фирменным flagship-экраном античита, тёмной operating-tool палитрой и role-switcher TMS/клиент/гонщик; этап M0 (инфраструктура) почти закрыт, реальная миграция начинается с M1 (mock data + dark theme).
